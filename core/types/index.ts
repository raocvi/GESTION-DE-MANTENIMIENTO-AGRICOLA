...
// Enums
export type Priority = 'low' | 'medium' | 'high' | 'critical' | 'stopped' | 'safety'
export type Criticality = 'low' | 'medium' | 'high' | 'critical'
export type AssetStatus = 'operative' | 'maintenance' | 'out_of_service' | 'warranty' | 'pending_parts' | 'diagnosis' | 'retired'
...
// Asset (summary for cross-module use)
...
// WorkOrder (summary for cross-module use)
